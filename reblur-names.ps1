...
$scale = 45   # much stronger blur for stubborn name text

# extra blur over name/text regions still readable; rect = @(x,y,w,h)
$jobs = [ordered]@{
    "2-compact-grid.png" = @(
        @(178, 150, 344, 46),    # Muniba Mazari name+headline
        @(598, 126, 344, 46),    # Ben Rycroft name+headline
        @(178, 600, 344, 46),    # Ponnurangam name+headline
        @(598, 576, 384, 46),    # Alexander Gomes name+headline
        @(185, 122, 118, 18),    # "Saquib Ahmad likes this"
        @(175, 572, 124, 20)     # "Sanyam Jain commented"
    )
    "3-focus-reader-insights.png" = @(
        @(300, 143, 344, 48),    # Rushika Rai name+headline
        @(300, 643, 344, 44),    # Yash Sharma name+headline
        @(298, 117, 120, 18),    # "Santanu Singha likes this"
        @(345, 611, 124, 20)     # "Arin Verma commented"
    )
}
